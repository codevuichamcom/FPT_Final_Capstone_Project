...
//        Mockito.when(handOverShiftCriteria.getHandOverShiftToday()).thenReturn(null);
    ...
    /**
     * check catch DataIntegrityViolationException
     */
    @Test
    void create_UTCID04() throws CustomNotFoundException {
        Mockito.when(transactionRepository.save(Mockito.any(Transaction.class))).thenThrow(DataIntegrityViolationException.class);
        Mockito.when(optionalValidate.getPumpShiftByPumpIdNotClose(Mockito.anyInt(), Mockito.anyLong(), Mockito.anyLong())).thenReturn(Mockito.mock(PumpShift.class));
        transactionService.create(Arrays.asList(Mockito.mock(TransactionDTOCreate.class), Mockito.mock(TransactionDTOCreate.class)));
     ...
     */
    @Test
    void create_UTCID05() throws CustomNotFoundException {
        Mockito.when(transactionRepository.save(Mockito.any(Transaction.class))).thenThrow(MockitoException.class);
        Mockito.when(optionalValidate.getPumpShiftByPumpIdNotClose(Mockito.anyInt(), Mockito.anyLong(), Mockito.anyLong())).thenReturn(Mockito.mock(PumpShift.class));
        transactionService.create(Arrays.asList(Mockito.mock(TransactionDTOCreate.class), Mockito.mock(TransactionDTOCreate.class)));
