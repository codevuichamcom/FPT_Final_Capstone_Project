...
class FuelImportControllerTest {
    ...
    @Test
    void create() throws CustomNotFoundException, CustomBadRequestException {
        Long creatDate = 16094340000000L;
        FuelImportDTO mockResult = FuelImportDTO.builder()
                .id(1)
                .name("name")
    ...
    @Test
    void update() throws CustomNotFoundException, CustomBadRequestException {
        Long creatDate = 16094340000000L;
        FuelImportDTO mockResult = FuelImportDTO.builder()
                .id(1)
                .name("name")
    ...
    @Test
    void delete() throws CustomNotFoundException, CustomBadRequestException {
        Long creatDate = 16094340000000L;
        FuelImportDTO mockResult = FuelImportDTO.builder()
                .id(1)
                .name("name")
