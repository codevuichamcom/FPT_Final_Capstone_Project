...
class PumpShiftControllerTest {
    ...
    void getAll() {
        ...
        Long closedTime = 16094640000000L;
        ...
        PumpShiftDTOFilter filter = PumpShiftDTOFilter.builder()
                ...
                .pageSize(PAGE_SIZE)
                .createdDateFrom(createDate)
                .createdDateTo(16094540000000L)
                .closedTimeFrom(closedTime)
                .createdDateTo(16094740000000L)
        ...
        HashMap<String, Object> mapResult = pumpShiftController.
                getAll(PAGE_INDEX, PAGE_SIZE, createDate,filter.getCreatedDateTo(),
                        filter.getClosedTimeFrom(),
                        filter.getClosedTimeTo(), "shiftName","pumpName",
                        stationIds, "stationName", statuses);
//
